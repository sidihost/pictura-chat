export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Pictura AI. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Pictura AI',
  ...
  'screen5.actions.signInCloud': 'Sign in to Pictura Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Pictura Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Pictura Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Pictura AI server instance',
