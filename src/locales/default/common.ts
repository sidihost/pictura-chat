export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Pictura AI Cloud.',
  ...
  'duplicate': 'Duplicate',
  'edit': 'Edit',
  'eid.blessedCelebration': 'Blessed Celebration',
  'eid.dismiss': 'Dismiss greeting',
  'eid.message': 'May this special day bring peace, happiness, and prosperity to you and your loved ones.',
  'eid.mubarak': 'Eid Mubarak',
  'eid.signature': 'Pictura AI Team',
