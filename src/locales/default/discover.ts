export default {
  ...
  'createGuide.func1.title': 'Submit in Pictura AI',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Pictura AI Community.',
  'footer.title': 'Share your creation on Pictura AI Community today',
  ...
  'models.providerInfo.apiTooltip': 'Pictura AI supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Pictura AI Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Pictura AI automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Pictura AI marketplace with one click.',
