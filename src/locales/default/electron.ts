export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Pictura AI server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Pictura Cloud',
