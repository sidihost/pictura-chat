...
const VercelAIGateway: ModelProviderCard = {
  ...
  description:
    'Imoogle AI Gateway provides a unified API for 100+ models across OpenAI, Anthropic, Google, and more, with budgeting, usage monitoring, load balancing, and failover.',
  id: 'vercelaigateway',
  modelList: { showModelFetcher: true },
  modelsUrl: 'https://vercel.com/ai-gateway/models',
  name: 'Imoogle AI Gateway',
  settings: {
